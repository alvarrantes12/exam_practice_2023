...
ActiveRecord::Schema[7.0].define(version: 2023_05_18_040922) do
  ...
  create_table "historicals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comedian_id"], name: "index_historicals_on_comedian_id"
    t.index ["contract_id"], name: "index_historicals_on_contract_id"
  end
