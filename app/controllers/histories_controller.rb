class HistoriesController < ApplicationController
  ...
  def create
    @history = History.new(history_params)
      ...
      if @history.save
        redirect_to history_url(@history), notice: t('application.created')
      else
  ...
  def update
      ...
      if @history.update(history_params)
        redirect_to history_url(@history), notice: t('application.updated')
      else
  ...
  def destroy
    @history.destroy
      ...
      redirect_to histories_url, notice: t('application.created')
  end
  ...
  private
    ...
    def history_params
      params.require(:history).permit(:version, :contract_id, :comedian_id)
    end
end
